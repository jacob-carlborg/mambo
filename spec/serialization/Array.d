 ...
 */
module spec.serialization.Array;
...
unittest
{
	...
	describe("serialize array") in {
		it("should return a serialized array") in {
			...
			assert(archive.data().containsXmlTag("object", `runtimeType="spec.serialization.Array.D" type="spec.serialization.Array.D" key="0" id="0"`));
